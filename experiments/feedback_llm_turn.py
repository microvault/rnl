...
task = (
    "- O mapa é 2x2 m, onde o robô começa sempre no meio com randomização de ângulo theta, e o target randomizado nas duas extremidades do mapa.\n"
...
def train():
    ...
    model.learn(
        ...
        device="mps",
        checkpoint=20000,
        checkpoint_path="./checkpoint_models_llm_turn",
        use_wandb=False,
        wandb_api_key="",
