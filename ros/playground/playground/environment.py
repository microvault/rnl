...
class SimpleSensorReader(Node):
    ...
    def laser_callback(self, msg):
        ...
        # Tratar inf e nan
        selected_ranges = np.nan_to_num(
            selected_ranges, nan=msg.range_max, posinf=msg.range_max, neginf=0.0
        )
    ...
    def odom_callback(self, msg):
        ...
        # LiDAR
        # clamped_lidar = [
        #     max(self.LIDAR_MIN, min(l, self.LIDAR_MAX)) for l in self.lidar_ranges
        # ]
        # Dist
        ...
        raw_state = (
            self.lidar_ranges + [clamped_dist, clamped_alpha] + clamped_action_oh
        )
