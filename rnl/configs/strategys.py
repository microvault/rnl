...
actions: List[ActionConfig] = [
    ...
    ActionConfig("FastActions", {"speed": "fast"}, "Ações rápidas para respostas imediatas")
]

rewards: List[RewardConfig] = [
    RewardConfig("time", {"scale_time": 0.01}, "Recompensa baseada no tempo gasto"),
    RewardConfig("distance", {"scale_distance": 0.1}, "Recompensa baseada na distância percorrida"),
    RewardConfig("all", {"scale_distance": 0.1, "scale_orientation": 0.003}, "Recompensa combinada de tempo, distância e orientação")
]
